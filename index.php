        ...
        <div class="container">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="assets/img/logos.png" alt="Logo">
                    </a>
                </div>
    ...
    <header id="home" class="header">
        ...
        <div class="container">
			<div class="video-container">
				<video src="assets/img/l.mp4" autoplay muted loop ></video>
			</div>
	...
	<section id="team" class="">
        ...
        <div class="container">            
            <div class="row">
				...
				<p>	Conozca a algunas de nuestras personas encantadoras, apasionadas y positivas.</p>
				</div>
...
nullam rhoncus tortor at dignissim vehicula.</p>
    ...
    <section class="counter">
        ...
        <div class="container">            
            <div class="row">
			<div class="title">
				<h2>somos geniales, mira algunos datos interesantes</h2>				
				</div>
			 <div class="col-xs-12 col-sm-2 col-md-2 wow fadeInUp animated" data-wow-delay=".1s">
               ...
               <div class="col-xs-12 col-sm-2 col-md-2 wow fadeInUp animated" data-wow-delay=".2s">
				   ...
				   <div class="col-xs-12 col-sm-2 col-md-2 wow fadeInUp animated" data-wow-delay=".5s">
							...
							<h2>133</h2>
							<span>Clientes en todo el mundo</span>
                  </div>  
...
<!-- =============== Gallery =============== -->
	...
	<div class="title">
				<h2>Gallery</h2>				
				<p>somos geniales, mira algunos datos interesantes</p>
				</div>
    ...
    <div class="container">
				...
				<div data-wow-delay=".6s" class="col-xs-12 col-sm-6 col-md-6 wow bounceIn  animated" style="visibility: visible; animation-delay: 0.6s; animation-name: bounceIn;">
					  ...
					  <section class="widget widget_text" id="text-15">
                         <h3 class="widget-title">CUCÚTA, COLOMBIA</h3> <div class="textwidget"><br>
                        <p>Tel: 999999999<br>
                        Mobile: 999999999<br>
                        E-mail: <a href="#">info@bastensoft.com</a></p>
